...
- Optional jump run estimate: a freefall track's opening point from an exit point, jump run heading, break-off altitude, and glide ratio, checked against the reach rings
